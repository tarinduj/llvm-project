...
func @simple_union() {
  ...
  // CHECK: %{{.*}} = presburger.set #presburger<"(d0, d1)[] : (-d0 - 2147483650 >= 0 or d0 - 2499 >= 0 or d0 >= 0 and -d0 + 2498 >= 0 and d1 >= 0)">

  %set8 = presburger.set #presburger<"(d0, d1)[] : (-d0 + -2147483650 >= 0  or d0 + -2499 >= 0  or d0  >= 0 and -d0 + 2498 >= 0 and d1  >= 0 )">
